                                ...
                                <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                                    ...
                                    <div className="min-w-55">
                                        ...
                                        <select
                                            ...
                                            className="mt-4 w-full rounded-full border border-zinc-300 px-3
                                             py-2 text-sm outline-none focus:border-zinc-900 disabled:opacity-60"
                                        >
                                            <option value="EM_SEPARACAO">
                                                Em separação
                                            </option>
